...
export default function Greeting({message} : {message: Array<string>}) {
    ...
    return(
        <div>
            <h1>{greeting}</h1>
            <div 
                className ={`w-fit px-5 py-1 rounded-lg cursor-pointer select-none active:translate-x-[1px] active:translate-y-[1px] relative bg-slate-300 text-white font-bold overflow-hidden ${BeforeStyle} clippedShape`}
